...
class UsernamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create username" do
    assert_difference('Username.count') do
      post usernames_url, params: { username: { cell_no: @username.cell_no, email: @username.email, father_name: @username.father_name, name: @username.name, next_to_kin: @username.next_to_kin, password: @username.password } }
    end
  ...
  test "should update username" do
    patch username_url(@username), params: { username: { cell_no: @username.cell_no, email: @username.email, father_name: @username.father_name, name: @username.name, next_to_kin: @username.next_to_kin, password: @username.password } }
