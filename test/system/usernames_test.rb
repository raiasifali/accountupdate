...
class UsernamesTest < ApplicationSystemTestCase
  ...
  test "creating a Username" do
    ...
    fill_in "Cell no", with: @username.cell_no
    fill_in "Email", with: @username.email
    fill_in "Father name", with: @username.father_name
    fill_in "Name", with: @username.name
    fill_in "Next to kin", with: @username.next_to_kin
